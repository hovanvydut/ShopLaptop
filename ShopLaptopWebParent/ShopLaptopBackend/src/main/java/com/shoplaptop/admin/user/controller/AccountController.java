...
import com.shoplaptop.admin.security.ShopLaptopUserDetails;
...
public class AccountController {
    ...
    @GetMapping("/account")
    public String viewDetails(@AuthenticationPrincipal ShopLaptopUserDetails loggedUser,
                              Model model) {
    ...
    public String saveUser(User user,
                           ...
                           @AuthenticationPrincipal ShopLaptopUserDetails loggedUser,
        ...
        // Update firstname, lastname in session
